...
* [Use Case: Interactively Explore Data with Interactive Spark Sessions]()
* [Lab 1: Using Interactive Sessions in the CDE UI](https://github.com/pdefusco/CDE119_ACE_WORKSHOP/blob/main/step_by_step_guides/english/part02_cde_sessions.md#using-interactive-sessions-in-the-cde-ui)
* [Lab 2: Using Interactive Sessions with the CDE CLI](https://github.com/pdefusco/CDE119_ACE_WORKSHOP/blob/main/step_by_step_guides/english/part02_cde_sessions.md#using-interactive-sessions-with-the-cde-cli)
* [Lab 3: Working with Spark and Iceberg in CDE Sessions](https://github.com/pdefusco/CDE119_ACE_WORKSHOP/blob/main/step_by_step_guides/english/part02_cde_sessions.md#working-with-spark-and-iceberg-in-cde-sessions)

## Use Case: Interactively Explore Data with Interactive Spark Sessions

In these labs you will learn to use CDE Sessions to explore data at scale. First you will become acquainted with CDE Sesssions in the UI and CLI. Then you will run some useful Spark and Iceberg commands to query your data with ease. You will learn more about Iceberg in Part 5 of the labs.

## Lab 1: Using Interactive Sessions in the CDE UI
...
## Lab 2: Using Interactive Sessions with the CDE CLI
...
## Lab 3: Working with Spark and Iceberg in CDE Sessions
