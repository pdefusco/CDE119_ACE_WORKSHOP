...
spark.sql("SELECT TSTAMP_TO_STRING(timestamp) AS tstamp_str, timestamp FROM CDE_WORKSHOP_{0}.EXPERIMENTAL_MOTORS_ENRICHED_{0} LIMIT 10".format(username)).show()
